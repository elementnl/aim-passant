...
const ARENA_CONFIGS = [
  ...
  },
  {
    ...
    obstacles: [
      ...
      { pos: [0, 1.25, 5],    size: [4, 2.5, 0.5] },
      { pos: [-9, 0.75, 5],   size: [1.5, 1.5, 1.5] },
      { pos: [9, 0.75, -5],   size: [1.5, 1.5, 1.5] },
      { pos: [-9, 0.75, -5],  size: [1.5, 1.5, 1.5] },
      { pos: [9, 0.75, 5],    size: [1.5, 1.5, 1.5] },
      { pos: [0, 0.75, 0],    size: [1.5, 1.5, 1.5] },
      { pos: [-3, 0.5, 9],    size: [3, 1, 0.5] },
      { pos: [3, 0.5, -9],    size: [3, 1, 0.5] },
      { pos: [-9, 1.25, 0],   size: [1.5, 2.5, 0.5] },
      { pos: [9, 1.25, 0],    size: [1.5, 2.5, 0.5] },
      { pos: [-3, 0.75, -3],  size: [1, 1.5, 1] },
      { pos: [3, 0.75, 3],    size: [1, 1.5, 1] },
    ],
  },
  {
    ...
    obstacles: [
      ...
      { pos: [-10, 0.5, -10], size: [6, 1, 0.8] },
      { pos: [10, 0.5, 10],   size: [6, 1, 0.8] },
      { pos: [-22, 1, 15],    size: [1.5, 2, 1.5] },
      { pos: [22, 1, -15],    size: [1.5, 2, 1.5] },
      { pos: [-15, 1, -8],    size: [1.5, 2, 1.5] },
      { pos: [15, 1, 8],      size: [1.5, 2, 1.5] },
    ],
  },
  {
    ...
    obstacles: [
      ...
      { pos: [-15, 1, -10],   size: [2, 2, 2] },
      { pos: [-10, 1, -15],   size: [2, 2, 2] },
      { pos: [-18, 1, -18],   size: [1.5, 2, 1.5] },
      { pos: [-5, 0.75, -5],  size: [1.5, 1.5, 1.5] },
      { pos: [-12, 1, -5],    size: [1.5, 2, 1.5] },
      { pos: [8, 1, 8],       size: [2, 2, 2] },
      { pos: [14, 1, -5],     size: [1.5, 2, 1.5] },
      { pos: [5, 1, 14],      size: [1.5, 2, 1.5] },
      { pos: [17, 1, 17],     size: [2, 2, 2] },
      { pos: [12, 1.5, 0],    size: [3, 3, 1] },
      { pos: [0, 1.5, 12],    size: [1, 3, 3] },
      { pos: [3, 0.5, -3],    size: [4, 1, 0.8] },
      { pos: [16, 2, -16],    size: [4, 4, 4] },
      { pos: [18, 0.5, 10],   size: [3, 1, 0.8] },
    ],
  },
];
